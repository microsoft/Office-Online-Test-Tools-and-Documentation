...
understanding the requirements for integration with WOPI clients such as Office Online.
...
..  glossary::
    ...
    Access token
        ...
        ..  admonition:: Office Online Tip
            ...
            In Office Online, an access token is generated by the host and passed to the client using the
            ``access_token`` parameter before the first WOPI request. See :ref:`Action URLs` and :ref:`Passing access
            tokens securely` for more information about how access tokens should be passed to Office Online.
        ...
        * Access tokens should expire (become invalid) automatically after a period of time. Hosts can use the
        ...
        ..  important::
            ...
            client. For example, in some cases Office Online will time out a user's session and present them with a
    ...
    Lock
        ...
        **X-WOPI-Lock** request header matches the lock ID, the :ref:`Unlock` request should be honored.
        ...
        ..  admonition:: Office Online Tip
            ...
            WOPI defines a :ref:`GetLock` operation. However, it is not currently called by Office Online. Instead,
    ...
    WOPISrc
        ...
        ..  admonition:: Office Online Tip
            ...
            See :ref:`Appending WOPISrc` for more details on how the WOPISrc is constructed and passed to Office
            Online.
